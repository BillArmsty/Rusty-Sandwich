...
// Build the data for the rustysandwich contract's calculateSwapV2 function
pub fn build_swap_v2_data(
    ...
    rustysandwich_contract
        .encode("calculateSwapV2", (amount_in, target_pool, startend_token, intermediary_token))
        .unwrap()
}

// Build the data for the rustysandwich contract's calculateSwapV3 function
